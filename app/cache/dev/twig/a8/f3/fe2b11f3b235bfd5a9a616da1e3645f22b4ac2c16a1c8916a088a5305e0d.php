...
\t\t\t\t\t";
        ...
        echo "\t\t\t\t\t";
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["torrents"]) ? $context["torrents"] : $this->getContext($context, "torrents")));
        foreach ($context['_seq'] as $context["_key"] => $context["torrent"]) {
            // line 29
            echo "\t\t\t\t\t\t";
            $context["calc_download_size"] = ((isset($context["calc_download_size"]) ? $context["calc_download_size"] : $this->getContext($context, "calc_download_size")) + $this->getAttribute($context["torrent"], "size", array()));
            // line 30
            echo "\t\t\t\t\t\t";
            if (((isset($context["calc_download_time"]) ? $context["calc_download_time"] : $this->getContext($context, "calc_download_time")) == 0)) {
                // line 31
                echo "\t\t\t\t\t\t\t";
            ...
            // line 33
            echo "\t\t\t\t\t\t";
            if (($this->getAttribute($context["torrent"], "getEta", array()) > (isset($context["calc_download_time"]) ? $context["calc_download_time"] : $this->getContext($context, "calc_download_time")))) {
                // line 34
                echo "\t\t\t\t\t\t\t";
                $context["calc_download_time"] = $this->getAttribute($context["torrent"], "getEta", array());
                // line 35
...
\t\t\t\t\t";
        ...
        if (( !(isset($context["calc_download_time"]) ? $context["calc_download_time"] : $this->getContext($context, "calc_download_time")) <= 0)) {
            // line 39
            echo "\t\t\t\t\t\t";
            $context["calc_download_rate"] = ((isset($context["calc_download_size"]) ? $context["calc_download_size"] : $this->getContext($context, "calc_download_size")) / (isset($context["calc_download_time"]) ? $context["calc_download_time"] : $this->getContext($context, "calc_download_time")));
            // line 40
            echo "\t\t\t\t\t";
        }
        // line 41
...
\t\t\t\t\t";
        // line 42
        if (((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")) <= 0)) {
            // line 43
            echo "\t\t\t\t\t\t0,00 Ko/s
\t\t\t\t\t";
        } elseif (((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")) >= ((1024 * 1024) * 1024))) {
            // line 45
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round(((((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")) / 1024) / 1024) / 1024), 0, "floor"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Gb"), "html", null, true);
            echo "/s
\t\t\t\t\t";
        } elseif (((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")) >= (1024 * 1024))) {
            // line 47
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round((((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")) / 1024) / 1024), 0, "floor"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Mb"), "html", null, true);
            echo "/s
\t\t\t\t\t";
        } elseif (((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")) >= 1024)) {
            // line 49
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round(((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")) / 1024), 0, "floor"), "html", null, true);
            echo " ";
...
\t\t\t\t\t";
            ...
            // line 51
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round((isset($context["calc_download_rate"]) ? $context["calc_download_rate"] : $this->getContext($context, "calc_download_rate")), 0, "floor"), "html", null, true);
            echo " ";
...
\t\t\t\t\t";
        // line 68
        if (((isset($context["diskspace"]) ? $context["diskspace"] : $this->getContext($context, "diskspace")) >= ((1024 * 1024) * 1024))) {
            // line 69
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round(((((isset($context["diskspace"]) ? $context["diskspace"] : $this->getContext($context, "diskspace")) / 1024) / 1024) / 1024), 0, "floor"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Gb"), "html", null, true);
            echo "
\t\t\t\t\t";
        } elseif (((isset($context["diskspace"]) ? $context["diskspace"] : $this->getContext($context, "diskspace")) >= (1024 * 1024))) {
            // line 71
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round((((isset($context["diskspace"]) ? $context["diskspace"] : $this->getContext($context, "diskspace")) / 1024) / 1024), 0, "floor"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Mb"), "html", null, true);
            echo "
\t\t\t\t\t";
        } elseif (((isset($context["diskspace"]) ? $context["diskspace"] : $this->getContext($context, "diskspace")) >= 1024)) {
            // line 73
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round(((isset($context["diskspace"]) ? $context["diskspace"] : $this->getContext($context, "diskspace")) / 1024), 0, "floor"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Kb"), "html", null, true);
            echo "
\t\t\t\t\t";
            ...
            // line 75
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, twig_round((isset($context["diskspace"]) ? $context["diskspace"] : $this->getContext($context, "diskspace")), 0, "floor"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("bytes"), "html", null, true);
            echo "
\t\t\t\t\t";
...
\t\t\t";
        // line 93
        if ((twig_length_filter($this->env, (isset($context["torrents"]) ? $context["torrents"] : $this->getContext($context, "torrents"))) > 0)) {
            // line 94
...
\t\t\t\t\t\t\t";
                ...
                // line 129
                echo "\t\t\t\t\t\t\t";
                $context["minutes"] = twig_round((($this->getAttribute($context["torrent"], "getEta", array()) - ((isset($context["hours"]) ? $context["hours"] : $this->getContext($context, "hours")) * 3600)) / 60));
                // line 130
                echo "\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t";
                ...
                if (($this->getAttribute($context["torrent"], "getEta", array()) > 0)) {
                    // line 135
                    echo "\t\t\t\t\t\t\t\t\t";
                    if (((isset($context["hours"]) ? $context["hours"] : $this->getContext($context, "hours")) > 0)) {
                        echo " ";
                        echo twig_escape_filter($this->env, (isset($context["hours"]) ? $context["hours"] : $this->getContext($context, "hours")), "html", null, true);
                        echo " ";
                    ...
                    if (((isset($context["minutes"]) ? $context["minutes"] : $this->getContext($context, "minutes")) > 0)) {
                        echo " ";
                        echo twig_escape_filter($this->env, (isset($context["minutes"]) ? $context["minutes"] : $this->getContext($context, "minutes")), "html", null, true);
                        echo " ";
                    ...
                    // line 137
                    echo "\t\t\t\t\t\t\t\t\t";
                    echo twig_escape_filter($this->env, (isset($context["seconds"]) ? $context["seconds"] : $this->getContext($context, "seconds")), "html", null, true);
                    echo " ";
...
\t\t\t\t\t\t\t\t\t";
                ...
                // line 170
                echo "\t\t\t\t\t\t\t\t\t<div class=\"";
                echo twig_escape_filter($this->env, (isset($context["progress"]) ? $context["progress"] : $this->getContext($context, "progress")), "html", null, true);
