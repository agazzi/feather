...
\t\t\t\t\t\t\t2 <small>le port de votre serveur rpc</small>
    ...
    \t\t\t\t\t";
        // line 59
        if (((isset($context["app_cache_path"]) ? $context["app_cache_path"] : $this->getContext($context, "app_cache_path")) == 777)) {
            // line 60
            echo "    \t\t\t\t\t\t";
            if (((isset($context["app_kernel_path"]) ? $context["app_kernel_path"] : $this->getContext($context, "app_kernel_path")) == 777)) {
                // line 61
                echo "    \t\t\t\t\t\t\t";
                if (((isset($context["app_kernel_path"]) ? $context["app_kernel_path"] : $this->getContext($context, "app_kernel_path")) == 777)) {
                    // line 62
                    echo "    \t\t\t\t\t\t\t\t";
                    if (((isset($context["app_bin_php5"]) ? $context["app_bin_php5"] : $this->getContext($context, "app_bin_php5")) == 1)) {
                        // line 63
                        echo "    \t\t\t\t\t\t\t\t\t";
                        if (((isset($context["app_bin_apache2"]) ? $context["app_bin_apache2"] : $this->getContext($context, "app_bin_apache2")) == 1)) {
                            // line 64
                            echo "    \t\t\t\t\t\t\t\t\t\t";
                            if (((isset($context["app_bin_transmission_daemon"]) ? $context["app_bin_transmission_daemon"] : $this->getContext($context, "app_bin_transmission_daemon")) == 1)) {
                                // line 65
...
\t\t\t\t\t\t    \t<span class=\"badge badge-";
        ...
        echo "\">";
        echo twig_escape_filter($this->env, (isset($context["app_cache_path"]) ? $context["app_cache_path"] : $this->getContext($context, "app_cache_path")), "html", null, true);
...
\t\t\t\t\t\t    \t<span class=\"badge badge-";
        ...
        echo "\">";
        echo twig_escape_filter($this->env, (isset($context["app_kernel_path"]) ? $context["app_kernel_path"] : $this->getContext($context, "app_kernel_path")), "html", null, true);
        echo "</span><strong>App</strong><br><em class=\"check-daemon-var\">/var/www/Feather/feather/app/</em>
\t\t\t\t\t\t    </li>
\t\t\t\t\t\t    <li class=\"list-group-item\">
\t\t\t\t\t\t    \t<span class=\"badge badge-";
        // line 131
        if (((isset($context["app_base_path"]) ? $context["app_base_path"] : $this->getContext($context, "app_base_path")) == 777)) {
            echo "success";
        } else {
            echo "danger";
        }
        echo "\">";
        echo twig_escape_filter($this->env, (isset($context["app_base_path"]) ? $context["app_base_path"] : $this->getContext($context, "app_base_path")), "html", null, true);
...
\t\t\t\t";
        // line 137
        if (((isset($context["modal_error"]) ? $context["modal_error"] : $this->getContext($context, "modal_error")) == 1)) {
            // line 138
...
\t  \t  \t  \t<button type=\"button\" class=\"btn btn-primary\" onclick=\"window.location.href='";
                                // line 171
                                echo $this->env->getExtension('routing')->getPath("app_feather_install_step");
                                echo "';\">Je suis prêt</button>
\t  \t  \t</div>
\t  \t</div>
\t</div>
</div>
