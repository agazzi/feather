...
<html lang=\"fr\">
    ...
    <body>
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "56a3189_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56a3189_0") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56a3189_jquery-1.9.1.min_1.js");
            // line 57
        ...
        ";
            // asset "56a3189_1"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56a3189_1") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56a3189_bootstrap.min_2.js");
            echo "            <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
        ";
            // asset "56a3189_2"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56a3189_2") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56a3189_globalize.min_3.js");
            echo "            <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
        ";
            ...
            // asset "56a3189"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56a3189") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56a3189.js");
            echo "            <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
        ";
