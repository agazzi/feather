...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'AppFeatherBundle' => 'App\\FeatherBundle\\AppFeatherBundle',
                'TransmissionBundle' => 'Transmission\\Bundle\\TransmissionBundle\\TransmissionBundle',
                'AppFeatherUserBundle' => 'App\\FeatherUserBundle\\AppFeatherUserBundle',
                'AppFeatherInstallBundle' => 'App\\FeatherInstallBundle\\AppFeatherInstallBundle',
            ...
            'transmission_dir' => '/home/downloads/',
            'transmission_tmp' => '/home/downloads/tmp/',
            'user_username' => 'admin',
            'user_password' => 'adminpass',
            'feather_name' => 'Feather',
            'feather_desc' => 'a simple flexible and beautiful torrent webapp',
            ...
            'assetic.filter.compass.bin' => 'C:\\Ruby21-x64\\bin\\compass.bat',
    ...
    {
        $this->services['assetic.filter.compass'] = $instance = new \Assetic\Filter\CompassFilter('C:\\Ruby21-x64\\bin\\compass.bat', '/usr/bin/ruby');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_db7b43849f14d66fd79b2b154d3ff8707b8db55ef4d8cd7093591379f745fe34');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'app_feather_logout'));
        ...
        $j->setOptions(array('login_path' => 'app_feather_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $k->setOptions(array('login_path' => 'app_feather_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'main', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'main', $j, $k, array('check_path' => 'app_feather_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54ad500266607', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, 'app_feather_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('main', 'app_feather_logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/App/FeatherBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/App/FeatherInstallBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
    ...
    {
        $a = new \Transmission\Client('127.0.0.1', 9091, NULL);
        $a->authenticate('transmission', 'transmission');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('feather_name', 'Feather');
        $instance->addGlobal('feather_description', 'a simple flexible and beautiful torrent webapp');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/App/FeatherBundle/Resources/views'), 'AppFeather');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/App/FeatherUserBundle/Resources/views'), 'AppFeatherUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/App/FeatherInstallBundle/Resources/views'), 'AppFeatherInstall');
