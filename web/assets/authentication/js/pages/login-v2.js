...
$(function() {
    ...
    if($('body').data('page') == 'login'){
        ...
        $.backstretch(["http://api.nativgaming.com/assets/images/gallery/login.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["http://api.nativgaming.com/assets/images/gallery/login4.jpg", "http://api.nativgaming.com/assets/images/gallery/login3.jpg", "http://api.nativgaming.com/assets/images/gallery/login2.jpg", "http://api.nativgaming.com/assets/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
